...
#ifndef SIDEXTYPENONE_H
#define SIDEXTYPENONE_H
...
class sidexNone : public sidexBase
{
...
protected: 
	  /* data */
    static const SIDEX_DATA_TYPE type = SIDEX_DATA_TYPE_NONE;
...
public:
     ...
     * @brief    Constructor.
     *
     * @returns an instance of sidexNone
     */
    sidexNone();
     ...
     *
     * @returns SIDEX_DATA_TYPE_BOOLEAN.
     *
     * @see sidexStdTypes.h
     */
     ...
     *
     *          The return character array is owned by the sidexNone.<br>
