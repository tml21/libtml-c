...
protected:
  ...
  bool         setCommandID(TML_COMMAND_HANDLE hCommand, TML_COMMAND_ID_TYPE cmdID);
  TML_COMMAND_ID_TYPE getCommandID(TML_COMMAND_HANDLE hCommand, TML_COMMAND_ID_TYPE idDefault = 0);
