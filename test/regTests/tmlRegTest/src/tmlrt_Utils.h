...
const array<SIDEX_TCHAR*, 5> LISTENERS_PORTS = { tmlrtT("4711"), tmlrtT("4712"), tmlrtT("815"), tmlrtT("420"), tmlrtT("1234") };
const array<SIDEX_TCHAR*, 5> LISTENERS_ADDRESS = { tmlrtT("0.0.0.0:4711"), tmlrtT("0.0.0.0:4712"), tmlrtT("0.0.0.0:815"), tmlrtT("0.0.0.0:420"), tmlrtT("0.0.0.0:1234") };

#if defined SIDEX_UNICODE || defined TML_UNICODE
#define tmlrt_cout	wcout
#else	//SIDEX_UNICODE or TML_UNICODE
#define tmlrt_cout	cout
#endif	//SIDEX_UNICODE or TML_UNICODE
