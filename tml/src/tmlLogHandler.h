...
#ifndef TMLLOGHANDLER_H
#define TMLLOGHANDLER_H
...
*/
#define TML_PREFERENCES_FILE    "tmlCore.sdx"
#define SIDEX_ROOT              "ROOT"
#define TML_PREFERENCES_GROUP   "tmlCorePreferences"
#define TML_OPT_ENABLE_FILE_LOG "EnableFileLog"
#define TML_OPT_USE_LOG_MASK    "UseLogMask"
#define TML_OPT_LOG_MASK_VALUE  "LogMaskValue"
#define TML_OPT_LOG_PATH        "LogPath"
...
* @brief  Definitions of logfile parameter
*/
#define TML_ADDITIONAL_TIMEOUT    "AdditionalTimeout"

/**
* @brief  Definitions of logfile parameter
*/
#define TML_EVENT_LOG_PERIOD    "EventLogPeriod"

/**
* @brief  Definitions of logfile parameter
*/
#define TML_EVENT_QUEUE_REMOVE_LOG_PERIOD    "EventQueueRemoveLogPeriod"

/**
* @brief  Definitions of logfile parameter
*/
#define TML_THREAD_POOL_ADD_PERIOD    "ThreadAddPeriod"
...
public:
     ...
     * @param   iTimeLength allocated length of the time string
     */
    static TML_INT64 getTime(char* sDate, int iDateLength, char* sTime, int iTimeLength);
     ...
     * @returns an instance of tmlLogHandler
     */
    tmlLogHandler(char* mode, int iFileIndex);
     ...
     */
    axl_bool createCriticalSectionObject(VortexMutex* mutex);
     ...
     * @returns axl_true on success.
     */
    axl_bool destroyCriticalSectionObject(VortexMutex* mutex);
     ...
     * @param   mutex       Reference to mutex for the critical section
     */
    void enterCriticalSection(VortexMutex* mutex);
     ...
     * @param   mutex       Reference to mutex for the critical section
     */
    void leaveCriticalSection(VortexMutex* mutex);
};

#endif  // TMLLOGHANDLER_H
